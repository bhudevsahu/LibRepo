...
<script type="text/javascript" src="../JS/checkinValidation.js"></script>
...
<input type="text" name="form" value="form3" style="visibility: hidden" />

<table border="0" cellpadding="4" align="center">
	<tr>
		<td colspan="3">
		<h2 align="center">&nbsp;&nbsp; &nbsp;&nbsp; Check-In Book</h2>
