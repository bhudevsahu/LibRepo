...
<input type="text" name="form" value="form2" style="visibility: hidden" />

<table border="0" cellpadding="4" align="center">
	<tr>
		<td colspan="3">
		<h2 align="center">&nbsp;&nbsp; &nbsp;&nbsp; Check-out Book</h2>
	...
	<tr>
		<td>Book ID:<span class="mandat"><font size="3" color="red">
		*</font></span></td>
		...
		<tr>
		<td>Branch ID:<span class="mandat"><font size="3"
			color="red">*</font></span></td>
		<td><input type="text" title="Enter Branch ID" id="brid"
			name="branch_id" size="1" maxlength="1" /></td>
		<td></td>
	</tr>
	<tr>
		<td> Card No.:<span class="mandat"><font size="3"
		color="red">*</font></span></td>
		<td><input type="text" title="Enter Card Number" id="cn"
			name="card_no" size="5" maxlength="4" /></td>
		<td></td>
	</tr>
